# Setup Selenium with ChromeDriver on Ubuntu/Debian
...
- The guide is based on ubuntu 24.04
...
```bash
git clone https://github.com/red-flames/LeetCode-Screenshotter.git
